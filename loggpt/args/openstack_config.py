...
def get_args():
    ...
    parser.add_argument('--dataset_name', default='OpenStack', type=str,
                        help='The name of the dataset to be parsed (default: OpenStack)')
    ...
    parser.add_argument('--segmentation', default=False, type=bool, help='Sliding window (default: True)')
    ...
    parser.add_argument('--threshold', default=5, type=int, help='Window step in second (default: 30)')
