...
def get_args():
    ...
    parser.add_argument('--sliding_window', default=False, type=bool, help='Sliding window (default: True)')
    parser.add_argument('--segmentation', default=True, type=bool, help='Segmentation method (default: True)')
    parser.add_argument('--window_size', default=12, type=int, help='Window size in second (default: 60)')
    parser.add_argument('--step_size', default=30, type=int, help='Window step in second (default: 30)')
    parser.add_argument('--threshold', default=5, type=int, help='Threshold for voting experts segmentation (default: 5)')
